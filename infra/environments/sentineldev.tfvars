...
oracle_price_worker_cpu           = 512
oracle_price_worker_memory        = 1024
...
avalanche_watcher_cpu           = 512      # 0.5 vCPU
avalanche_watcher_memory        = 1024     # 1 GB
avalanche_watcher_desired_count = 1        # Singleton
avalanche_watcher_image_tag     = "latest" # Override in CI/CD

# Backup worker sizing
avalanche_backup_worker_cpu           = 256
avalanche_backup_worker_memory        = 512
...
# Redis
avalanche_redis_node_type          = "cache.t4g.small" # 1.55 GB
