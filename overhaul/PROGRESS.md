...
| 04 | findings/04-pricing.md | services/oracle_price_worker, oracle_backfill, oracle_pricing, offchain_price_fetcher, live_data, adapters coingecko/sky/skydata, inbound http, cmd oracle-*/offchain-* | running |
...
| 06 | findings/06-offchain-temporal-shared.md | services/anchorage_tracker, maple_graphql_indexer, adapters/maple, entity/maple, adapters/etherscan, adapters/temporal, services/shared, pkg httpclient/retry/proxytls/telemetry/env | running (resumed once after a stall) |
| 07 | findings/07-postgres-schema.md | adapters/outbound/postgres, db/migrations, db/migrator, testutil/db.go, cmd/util/migrate + generate-er | running |
...
| 10 | findings/10-composition-roots.md | all 34 cmd/*/main.go, dexbootstrap, pkg/env, lifecycle, telemetry init; main.go churn classification | running |
