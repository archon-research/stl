...
SELECT o.id, t.id, true, 'USD', 0, 'ARCT-511: initial Aave V3 Arbitrum oracle registration'
FROM oracle o
...
BEGIN
    ...
    IF cnt < 1 THEN
        RAISE EXCEPTION 'pool 0x794a61358D6845594F94dc1DB02A252b5b4814aD on chain 42161 -> aave_v3_arbitrum protocol_oracle binding missing';
    END IF;
