...
INSERT INTO prime (name, vault_address) VALUES
...
-- Partitioned as a TimescaleDB hypertable on synced_at.
CREATE TABLE IF NOT EXISTS prime_debt (
                                          ...
                                          UNIQUE (prime_id, block_number, block_version, synced_at)
);

SELECT create_hypertable('prime_debt', 'synced_at', if_not_exists => TRUE);
