...
func TestProjectionWindow(t *testing.T) {
	...
	t.Run("NullIsUnbounded", func(t *testing.T) {
	...
	t.Run("BoundedFromColdCannotDiscoverHistory", func(t *testing.T) {
	...
	t.Run("IsStampedOnTheRunRecord", func(t *testing.T) {
	...
	t.Run("BoundedAfterBootstrapClosesAndIsIdempotent", func(t *testing.T) {
	...
	t.Run("IsInterpolatedAsALiteral", func(t *testing.T) {
		var src string
		if err := pool.QueryRow(ctx, `
	...
	t.Run("RefusesANonPositiveInterval", func(t *testing.T) {
	...
	t.Run("LeavesExactlyOneSignature", func(t *testing.T) {
