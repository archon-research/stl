...
END $$;`
	...
	for _, c := range []struct {
		...
		{"A supplier latest obs (multi-observation kept)", loanInstrument, "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "150", 2},
		{"B borrow leg (loan token)", loanInstrument, "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb", "30", 1},
		{"B collateral leg (collateral token)", collInstrument, "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb", "5", 1},
		{"C supply/borrow netted (|100-40|)", loanInstrument, "cccccccccccccccccccccccccccccccccccccccc", "60", 1},
		{"D observed twice at one block: one logical key, latest timestamp wins", loanInstrument, "dddddddddddddddddddddddddddddddddddddddd", "20", 1},
		{"E collateral closed: open + one closing zero-row", collInstrument, "eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee", "0", 2},
		{"F loan closed: borrow + one closing zero-row", loanInstrument, "efefefefefefefefefefefefefefefefefefefef", "0", 2},
		{"G leading + repeated zeros dropped: open + one close", collInstrument, "f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0", "0", 2},
