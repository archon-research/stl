...
func parseConfig(args []string) (config, error) {
	...
	finalityDepth := fs.Int64("finality-depth", 0, fmt.Sprintf("Blocks below the head to pin at (default: FINALITY_DEPTH, else %d on mainnet; required on every other chain)", uniswapv4bootstrap.DefaultFinalityDepth))
