...
func mainnetEntries() []*TokenEntry {
	...
	return []*TokenEntry{
		...
		{ContractAddress: common.HexToAddress("0x779224df1c756b4edd899854f32a53e8c2b2ce5d"), WalletAddress: spark, AssetAddress: pyusd, Star: "spark", Chain: "mainnet", Protocol: "sparklend", AllocationType: "allocation", TokenType: "atoken", CreatedAtBlock: new(int64(23118264))},
		...
		{ContractAddress: common.HexToAddress("0xe41a0583334f0dc4e023acd0bfef3667f6fe0597"), WalletAddress: spark, AssetAddress: usds, Star: "spark", Chain: "mainnet", Protocol: "morpho", AllocationType: "allocation", TokenType: "erc4626", CreatedAtBlock: new(int64(22932160))},
		...
		// ── Spark: Arkis (ERC4626) ──
		{ContractAddress: common.HexToAddress("0x38464507e02c983f20428a6e8566693fe9e422a9"), WalletAddress: spark, AssetAddress: usdc, Star: "spark", Chain: "mainnet", Protocol: "arkis", AllocationType: "allocation", TokenType: "erc4626", CreatedAtBlock: new(int64(23896879))},
		...
		{ContractAddress: common.HexToAddress("0xa632d59b9b804a956bfaa9b48af3a1b74808fc1f"), WalletAddress: spark, AssetAddress: pyusd, Star: "spark", Chain: "mainnet", Protocol: "curve", AllocationType: "allocation", TokenType: "curve", CreatedAtBlock: new(int64(23390887))},
		...
		{ContractAddress: common.HexToAddress("0x49506c3aa028693458d6ee816b2ec28522946872"), WalletAddress: spark, Star: "spark", Chain: "mainnet", Protocol: "anchorage", AllocationType: "allocation", TokenType: "anchorage", CreatedAtBlock: new(int64(24019368))},
		...
		{ContractAddress: common.HexToAddress("0x68215b6533c47ff9f7125ac95adf00fe4a62f79e"), WalletAddress: grove, AssetAddress: usdc, Star: "grove", Chain: "mainnet", Protocol: "aave", AllocationType: "allocation", TokenType: "atoken", CreatedAtBlock: new(int64(23132230))},
		...
		{ContractAddress: common.HexToAddress("0x51c2d74017390cbbd30550179a16a1c28f7210fc"), WalletAddress: grove, AssetAddress: usdc, Star: "grove", Chain: "mainnet", Protocol: "securitize", AllocationType: "allocation", TokenType: "securitize", CreatedAtBlock: new(int64(24041058))},

		// ── Grove: Steakhouse (ERC4626) ──
		{ContractAddress: common.HexToAddress("0xbeef2b5fd3d94469b7782aebe6364e6e6fb1b709"), WalletAddress: grove, AssetAddress: usdc, Star: "grove", Chain: "mainnet", Protocol: "steakhouse", AllocationType: "allocation", TokenType: "erc4626", CreatedAtBlock: new(int64(24148141))},
...
func avalancheEntries() []*TokenEntry {
	...
	return []*TokenEntry{
		{ContractAddress: common.HexToAddress("0x28b3a8fb53b741a8fd78c0fb9a6b2393d896a43d"), WalletAddress: spark, AssetAddress: addr("0xb97ef9ef8734c71904d8002f8b6bc66dd9c48a6e"), Star: "spark", Chain: "avalanche-c", Protocol: "spark", AllocationType: "allocation", TokenType: "erc4626", CreatedAtBlock: new(int64(69983672))},
		...
		{ContractAddress: common.HexToAddress("0x2c0adff8e114f3ca106051144353ac703d24b901"), WalletAddress: grove, Star: "grove", Chain: "avalanche-c", Protocol: "arch", AllocationType: "allocation", TokenType: "erc20", CreatedAtBlock: new(int64(72633046))},
	}
}
...
func plumeEntries() []*TokenEntry {
	...
	return []*TokenEntry{
		...
		{ContractAddress: common.HexToAddress("0xa5d465251fbcc907f5dd6bb2145488dfc6a2627b"), WalletAddress: grove, AssetAddress: addr("0x222365ef19f7947e5484218551b56bb3965aa7af"), Star: "grove", Chain: "plume", Protocol: "centrifuge", AllocationType: "allocation", TokenType: "centrifuge_feeder", CreatedAtBlock: new(int64(41311106))},
...
func monadEntries() []*TokenEntry {
	...
	return []*TokenEntry{
		{ContractAddress: common.HexToAddress("0x00000000efe302beaa2b3e6e1b18d08d69a9012a"), WalletAddress: grove, Star: "grove", Chain: "monad", Protocol: "agora", AllocationType: "asset", TokenType: "erc20", CreatedAtBlock: new(int64(36870131))},
		{ContractAddress: common.HexToAddress("0x6b405dca74897c9442d369dcf6c0ec230f7e1c7c"), WalletAddress: grove, AssetAddress: addr("0x00000000efe302beaa2b3e6e1b18d08d69a9012a"), Star: "grove", Chain: "monad", Protocol: "uniswap", AllocationType: "allocation", TokenType: "uni_v3_lp", CreatedAtBlock: new(int64(39598901))},
	}
}
