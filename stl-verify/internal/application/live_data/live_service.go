...
func (s *LiveService) tryAddBlock(block LightBlock) bool {
	...
	copy(s.unfinalizedBlocks[insertIdx+1:], s.unfinalizedBlocks[insertIdx:])
	s.unfinalizedBlocks[insertIdx] = block
...
// Utility functions (shared with backfill_service.go)
