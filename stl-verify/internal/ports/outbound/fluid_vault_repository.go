...
type FluidVaultRepository interface {
	// RecordVaults registers vaults and returns vault address -> fluid_vault.id.
	...
	RecordVaults(ctx context.Context, tx pgx.Tx, vaults []*entity.FluidVault) (map[common.Address]int64, error)
