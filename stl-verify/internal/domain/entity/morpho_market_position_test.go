...
func TestNewMorphoMarketPosition(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "valid position", userID: 1, marketID: 1, block: 100, version: 0, timestamp: ts,
			supShares: big.NewInt(1000), borShares: zero, collateral: big.NewInt(500),
			supAssets: big.NewInt(1050), borAssets: zero,
		},
		{
			name: "zero user ID", userID: 0, marketID: 1, block: 100, version: 0, timestamp: ts,
		...
		{
			name: "zero market ID", userID: 1, marketID: 0, block: 100, version: 0, timestamp: ts,
			supShares: zero, borShares: zero, collateral: zero,
			supAssets: zero, borAssets: zero,
			wantErr: true, errContains: "morphoMarketID must be positive",
		},
		{
			name: "zero timestamp", userID: 1, marketID: 1, block: 100, version: 0, timestamp: time.Time{},
			supShares: zero, borShares: zero, collateral: zero,
			supAssets: zero, borAssets: zero,
			wantErr: true, errContains: "timestamp must not be zero",
		},
		{
			name: "nil supply shares", userID: 1, marketID: 1, block: 100, version: 0, timestamp: ts,
			supShares: nil, borShares: zero, collateral: zero,
			supAssets: zero, borAssets: zero,
			wantErr: true, errContains: "supplyShares must not be nil",
		},
		{
			name: "nil borrow shares", userID: 1, marketID: 1, block: 100, version: 0, timestamp: ts,
			supShares: zero, borShares: nil, collateral: zero,
			supAssets: zero, borAssets: zero,
			wantErr: true, errContains: "borrowShares must not be nil",
		},
		{
			name: "nil collateral", userID: 1, marketID: 1, block: 100, version: 0, timestamp: ts,
			supShares: zero, borShares: zero, collateral: nil,
			supAssets: zero, borAssets: zero,
			wantErr: true, errContains: "collateral must not be nil",
		},
		{
			name: "nil supply assets", userID: 1, marketID: 1, block: 100, version: 0, timestamp: ts,
			supShares: zero, borShares: zero, collateral: zero,
			supAssets: nil, borAssets: zero,
			wantErr: true, errContains: "supplyAssets must not be nil",
		},
		{
			name: "nil borrow assets", userID: 1, marketID: 1, block: 100, version: 0, timestamp: ts,
			supShares: zero, borShares: zero, collateral: zero,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := NewMorphoMarketPosition(tt.userID, tt.marketID, tt.block, tt.version, tt.timestamp, tt.supShares, tt.borShares, tt.collateral, tt.supAssets, tt.borAssets)
			if tt.wantErr {
				if err == nil {
