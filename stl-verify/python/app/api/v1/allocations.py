...
class AllocationActivityBucketResponse(BaseModel):
    ...
    net_flow_usd: Decimal = Field(
        description=(
            ...
            "(underlying_value / balance, falling back to the raw tx_amount when the ratio is "
            "unavailable) and priced at the receipt token's latest underlying oracle price; direct "
            "holdings contribute 0. Lets clients reconstruct a balance series by anchoring at the "
