...
def test_post_rrc_mapped_asset(app_factory) -> None:
    ...
    with TestClient(app) as client:
        response = client.post("/v1/risk/rrc", json={"asset": "aUSDC", "usd_exposure": "1000"})
...
def test_post_rrc_rejects_non_positive_exposure(app_factory) -> None:
    ...
    with TestClient(app) as client:
        zero = client.post("/v1/risk/rrc", json={"asset": "aUSDC", "usd_exposure": "0"})
        negative = client.post("/v1/risk/rrc", json={"asset": "aUSDC", "usd_exposure": "-1"})
