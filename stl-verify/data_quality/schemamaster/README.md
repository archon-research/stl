...
- `uniswap_v3_*` and `uniswap_v4_*` — the Uniswap V3 (VEC-261) and V4 (VEC-475) DEX layers, same situation as `curve_*`; column-level cataloguing is a follow-up alongside it.
