...
export type PrimeProvenance = Schemas['PrimeProvenanceResponse'];
...
export type ProtocolEventBucket = Schemas['ProtocolEventBucketResponse'];
export type ProtocolEventsEnvelope = Schemas['ProtocolEventsEnvelope'];
export type ProvenanceAvailability = Schemas['ProvenanceAvailabilityResponse'];
