...
export interface paths {
  ...
  '/v1/primes/{prime_id}/debt/latest': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    /** Get Latest Prime Debt Snapshot */
    get: operations['get_latest_prime_debt_snapshot_v1_primes__prime_id__debt_latest_get'];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
...
export interface operations {
  ...
  get_latest_prime_debt_snapshot_v1_primes__prime_id__debt_latest_get: {
    parameters: {
      query?: never;
      header?: never;
      path: {
