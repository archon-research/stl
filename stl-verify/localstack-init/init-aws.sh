...
for queue in prime-debt curve-indexing uniswap-v3-indexing uniswap-v4-indexing; do
...
# Allocation tracker also runs on Robinhood
create_consumer_queue "robinhood" "allocation-tracker"
